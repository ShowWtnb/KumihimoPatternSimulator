...
const EditJsonDialog = ({ isOpen, onClosedDialog }) => {
    ...
    useEffect(() => {
        if (open) {
            ...
            setTextValue(SAVED_PATTERNS);
        } else {
            // console.log('EditJsonDialog onClosing', closingEvent);
    ...
    return (
        <div >
            <Dialog disableEscapeKeyDown open={open} onClose={handleClose}>
                <DialogTitle>Edit Saved Patterns</DialogTitle>
                <DialogContent>
